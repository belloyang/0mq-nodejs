#ifndef AsyncTask_HarvestTimingSOH_h__
#define AsyncTask_HarvestTimingSOH_h__

#include "IAsyncTask.h"
#include <Operations/operations.h>
#include <Client/IClient.h>

class AsyncTask_HarvestTimingSOH : public IAsyncTask
{
public:
  AsyncTask_HarvestTimingSOH(const std::string& libPath,
    const std::string& paramsJSON,
    const float updateStep,
    const std::shared_ptr<IHasher>& hasher,
    const std::shared_ptr<ILogger>& logger,
    const std::shared_ptr<IClient>& client);
  virtual ~AsyncTask_HarvestTimingSOH() = default;
...
#endif //AsyncTask_HarvestTimingSOH_h__
