#ifndef PlatformUtilsImpl_POSIX_h__
#define PlatformUtilsImpl_POSIX_h__

#include "../../PlatformUtils/IPlatformUtilsImpl.h"

class PlatformUtilsImpl_POSIX : public IPlatformUtilsImpl
{
public:
  PlatformUtilsImpl_POSIX(const std::shared_ptr<ILogger>& logger);
  virtual ~PlatformUtilsImpl_POSIX() = default;
